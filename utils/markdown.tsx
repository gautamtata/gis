					...
					<Tooltip label={copyButtonText} placement='top'>
						<Button
							...
							onClick={() => {
								...
								setCopyButtonIcon(<CheckmarkIcon boxSize='8px' />);
								setTimeout(() => {
									setCopyButtonText('Copy code');
									setCopyButtonIcon(<CopyIcon boxSize='8px' />);
								}, 3000);
							}}
						>
							{copyButtonText}
					...
					<Tooltip label={'Add cell'} placement='top'>
						<Button
							...
							onClick={() => {
								...
								setTimeout(() => {
									setCellButtonIcon(<AddIcon boxSize='8px' />);
...
export const getCustomMarkdownComponents = ({
	...
	return {
		...
		code: (props: MarkdownComponentProps) => {
			return (
				<CodeComponent {...props} showCodeBlockActions={showCodeBlockActions} />
			);
		},
